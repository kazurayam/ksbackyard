...
@RunWith(Suite.class)
@SuiteClasses([
	AssertTest.class, ImageCollectionDifferTest.class, QuietBrowserTest.class, RunConfigurationWrapperTest.class, ScreenshotDriverTest.class, URLParserTest.class
])
